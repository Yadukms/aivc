  ...
  return (
    <section className="wwd-changes">
      <div className="wwd-changes-wrapper">
        <p className="wwd-changes-lead">
          If that sounds like your firm, we should talk. Your proprietary IP can become a product business — <strong>and we're the partner that makes it happen.</strong>
        </p>
        ...
        <div className="wwd-changes-grid">
          ...
          <div className="wwd-changes-col">
            ...
            <p className="col-text">
              ...
              <span className="text-highlight"> 25–30%</span>. For firms that pursue a carve-out, multiples
              reach <span className="text-highlight">16–18x EBITDA</span> or higher. That's not incremental
        ...
        <div className="wwd-changes-footnote-row">
          <p className="footer-footnote">* Based on research from Pepperdine PCMP 2025 – EisnerAmper 2025 – Capstone Partners</p>
        </div>
